...
The package is a private local alpha. It does **not** claim WCAG certification, complete screen-reader coverage, or physical-device verification. The repository's `docs/library-support.md` is the detailed support and quality record.
